  ...
  return (
    <header className="bg-blue-1">
      <div className="absolute top-[18px] md:top-[42px] md:left-[46px] left-3">
        <button className="py-2 px-5 bg-gray-3 text-base" onClick={toggleMenu}>
          Seach for places
        </button>
      </div>
      <nav
        ...
        } top-0 left-0 right-0 h-[672px] md:h-full md:py-3 md:px-[46px] drop-shadow-2xl md:w-[459px] bg-blue-1 text-center items-center justify-center z-50 overflow-auto no-scrollbar p-3 `}
      >
        <button className="flex ml-auto pb-6 md:pb-[38px]" onClick={toggleMenu}>
          <ExitIcon />
        </button>
        <form className="flex gap-3" onSubmit={search}>
          ...
          <button type="submit" className="bg-blue-3 text-base px-5 py-3">
            Search
          </button>
        </form>
